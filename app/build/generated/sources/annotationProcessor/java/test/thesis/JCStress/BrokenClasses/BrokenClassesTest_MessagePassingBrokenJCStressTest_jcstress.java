...
import thesis.JCStress.BrokenClasses.BrokenClassesTest.MessagePassingBrokenJCStressTest;
import org.openjdk.jcstress.infra.results.L_Result;

public final class BrokenClassesTest_MessagePassingBrokenJCStressTest_jcstress extends Runner<L_Result> {

    volatile WorkerSync workerSync;

    public BrokenClassesTest_MessagePassingBrokenJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        MessagePassingBrokenJCStressTest t;
        MessagePassingBrokenJCStressTest s;
        L_Result r;

        public JcstressThread_APICheck_actor1(MessagePassingBrokenJCStressTest t, MessagePassingBrokenJCStressTest s, L_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(MessagePassingBrokenJCStressTest t, MessagePassingBrokenJCStressTest s, L_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<L_Result> counter) throws Throwable {
        final MessagePassingBrokenJCStressTest s = new MessagePassingBrokenJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        MessagePassingBrokenJCStressTest[] ss;
        L_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(MessagePassingBrokenJCStressTest[] ss, L_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(MessagePassingBrokenJCStressTest[] ls, L_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(MessagePassingBrokenJCStressTest[] ss, L_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(MessagePassingBrokenJCStressTest[] ls, L_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2(lr[c]);
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            MessagePassingBrokenJCStressTest[] ls = new MessagePassingBrokenJCStressTest[size];
            L_Result[] lr = new L_Result[size];
            for (int c = 0; c < size; c++) {
                MessagePassingBrokenJCStressTest s = new MessagePassingBrokenJCStressTest();
    ...
    public ArrayList<CounterThread<L_Result>> internalRun() {
        ...
        MessagePassingBrokenJCStressTest[] ls = new MessagePassingBrokenJCStressTest[len];
        L_Result[] lr = new L_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new MessagePassingBrokenJCStressTest();
            lr[c] = new L_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<L_Result> cnt, MessagePassingBrokenJCStressTest[] ls, L_Result[] lr, MessagePassingBrokenJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            L_Result r = lr[c];
            MessagePassingBrokenJCStressTest s = ls[c];
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<L_Result> cnt, MessagePassingBrokenJCStressTest[] ls, L_Result[] lr, MessagePassingBrokenJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            L_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<L_Result> {
        MessagePassingBrokenJCStressTest[] ss;
        L_Result[] rs;
        MessagePassingBrokenJCStressTest test;

        public JcstressThread_actor1(MessagePassingBrokenJCStressTest[] ss, L_Result[] rs, MessagePassingBrokenJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            MessagePassingBrokenJCStressTest[] ls = ss;
            L_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<L_Result> {
        ...
        public JcstressThread_actor2(MessagePassingBrokenJCStressTest[] ss, L_Result[] rs, MessagePassingBrokenJCStressTest test) {
