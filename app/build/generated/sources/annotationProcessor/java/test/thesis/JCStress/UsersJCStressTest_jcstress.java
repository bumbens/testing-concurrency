...
import thesis.JCStress.UsersJCStressTest;
import org.openjdk.jcstress.infra.results.Z_Result;

public final class UsersJCStressTest_jcstress extends Runner<Z_Result> {

    volatile WorkerSync workerSync;

    public UsersJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor1(UsersJCStressTest t, UsersJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(UsersJCStressTest t, UsersJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor1(UsersJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(UsersJCStressTest[] ls, Z_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(UsersJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(UsersJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            UsersJCStressTest[] ls = new UsersJCStressTest[size];
            Z_Result[] lr = new Z_Result[size];
            for (int c = 0; c < size; c++) {
                UsersJCStressTest s = new UsersJCStressTest();
    ...
    public ArrayList<CounterThread<Z_Result>> internalRun() {
        ...
        UsersJCStressTest[] ls = new UsersJCStressTest[len];
    ...
    public class JcstressThread_actor1 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor1(UsersJCStressTest[] ss, Z_Result[] rs, UsersJCStressTest test) {
    ...
    public class JcstressThread_actor2 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor2(UsersJCStressTest[] ss, Z_Result[] rs, UsersJCStressTest test) {
