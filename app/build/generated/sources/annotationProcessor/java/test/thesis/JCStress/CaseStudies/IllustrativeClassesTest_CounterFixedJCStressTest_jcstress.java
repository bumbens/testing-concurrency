...
import thesis.JCStress.CaseStudies.IllustrativeClassesTest.CounterFixedJCStressTest;
import org.openjdk.jcstress.infra.results.I_Result;

public final class IllustrativeClassesTest_CounterFixedJCStressTest_jcstress extends Runner<I_Result> {

    volatile WorkerSync workerSync;

    public IllustrativeClassesTest_CounterFixedJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        CounterFixedJCStressTest t;
        CounterFixedJCStressTest s;
        I_Result r;

        public JcstressThread_APICheck_actor1(CounterFixedJCStressTest t, CounterFixedJCStressTest s, I_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(CounterFixedJCStressTest t, CounterFixedJCStressTest s, I_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<I_Result> counter) throws Throwable {
        final CounterFixedJCStressTest s = new CounterFixedJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        CounterFixedJCStressTest[] ss;
        I_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(CounterFixedJCStressTest[] ss, I_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(CounterFixedJCStressTest[] ls, I_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(CounterFixedJCStressTest[] ss, I_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(CounterFixedJCStressTest[] ls, I_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            CounterFixedJCStressTest[] ls = new CounterFixedJCStressTest[size];
            I_Result[] lr = new I_Result[size];
            for (int c = 0; c < size; c++) {
                CounterFixedJCStressTest s = new CounterFixedJCStressTest();
    ...
    public ArrayList<CounterThread<I_Result>> internalRun() {
        ...
        CounterFixedJCStressTest[] ls = new CounterFixedJCStressTest[len];
        I_Result[] lr = new I_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new CounterFixedJCStressTest();
            lr[c] = new I_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<I_Result> cnt, CounterFixedJCStressTest[] ls, I_Result[] lr, CounterFixedJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            I_Result r = lr[c];
            CounterFixedJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<I_Result> cnt, CounterFixedJCStressTest[] ls, I_Result[] lr, CounterFixedJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            I_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<I_Result> {
        CounterFixedJCStressTest[] ss;
        I_Result[] rs;
        CounterFixedJCStressTest test;

        public JcstressThread_actor1(CounterFixedJCStressTest[] ss, I_Result[] rs, CounterFixedJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            CounterFixedJCStressTest[] ls = ss;
            I_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<I_Result> {
        ...
        public JcstressThread_actor2(CounterFixedJCStressTest[] ss, I_Result[] rs, CounterFixedJCStressTest test) {
