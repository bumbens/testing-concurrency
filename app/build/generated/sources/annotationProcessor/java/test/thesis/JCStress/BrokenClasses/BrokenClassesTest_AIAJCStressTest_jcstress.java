...
import thesis.JCStress.BrokenClasses.BrokenClassesTest.AIAJCStressTest;
import org.openjdk.jcstress.infra.results.Z_Result;

public final class BrokenClassesTest_AIAJCStressTest_jcstress extends Runner<Z_Result> {

    volatile WorkerSync workerSync;

    public BrokenClassesTest_AIAJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor1(AIAJCStressTest t, AIAJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(AIAJCStressTest t, AIAJCStressTest s, Z_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<Z_Result> counter) throws Throwable {
        final AIAJCStressTest s = new AIAJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor1(AIAJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(AIAJCStressTest[] ls, Z_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(AIAJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(AIAJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            AIAJCStressTest[] ls = new AIAJCStressTest[size];
            Z_Result[] lr = new Z_Result[size];
            for (int c = 0; c < size; c++) {
                AIAJCStressTest s = new AIAJCStressTest();
    ...
    public ArrayList<CounterThread<Z_Result>> internalRun() {
        ...
        AIAJCStressTest[] ls = new AIAJCStressTest[len];
        Z_Result[] lr = new Z_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new AIAJCStressTest();
            lr[c] = new Z_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<Z_Result> cnt, AIAJCStressTest[] ls, Z_Result[] lr, AIAJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
            AIAJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<Z_Result> cnt, AIAJCStressTest[] ls, Z_Result[] lr, AIAJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<Z_Result> {
        AIAJCStressTest[] ss;
        Z_Result[] rs;
        AIAJCStressTest test;

        public JcstressThread_actor1(AIAJCStressTest[] ss, Z_Result[] rs, AIAJCStressTest test) {
    ...
    public class JcstressThread_actor2 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor2(AIAJCStressTest[] ss, Z_Result[] rs, AIAJCStressTest test) {
