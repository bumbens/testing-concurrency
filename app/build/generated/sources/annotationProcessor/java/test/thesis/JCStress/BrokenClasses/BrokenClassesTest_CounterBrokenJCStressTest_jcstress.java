...
import thesis.JCStress.BrokenClasses.BrokenClassesTest.CounterBrokenJCStressTest;
import org.openjdk.jcstress.infra.results.I_Result;

public final class BrokenClassesTest_CounterBrokenJCStressTest_jcstress extends Runner<I_Result> {

    volatile WorkerSync workerSync;

    public BrokenClassesTest_CounterBrokenJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        CounterBrokenJCStressTest t;
        CounterBrokenJCStressTest s;
        I_Result r;

        public JcstressThread_APICheck_actor1(CounterBrokenJCStressTest t, CounterBrokenJCStressTest s, I_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(CounterBrokenJCStressTest t, CounterBrokenJCStressTest s, I_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<I_Result> counter) throws Throwable {
        final CounterBrokenJCStressTest s = new CounterBrokenJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        CounterBrokenJCStressTest[] ss;
        I_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(CounterBrokenJCStressTest[] ss, I_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(CounterBrokenJCStressTest[] ls, I_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(CounterBrokenJCStressTest[] ss, I_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(CounterBrokenJCStressTest[] ls, I_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            CounterBrokenJCStressTest[] ls = new CounterBrokenJCStressTest[size];
            I_Result[] lr = new I_Result[size];
            for (int c = 0; c < size; c++) {
                CounterBrokenJCStressTest s = new CounterBrokenJCStressTest();
    ...
    public ArrayList<CounterThread<I_Result>> internalRun() {
        ...
        CounterBrokenJCStressTest[] ls = new CounterBrokenJCStressTest[len];
        I_Result[] lr = new I_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new CounterBrokenJCStressTest();
            lr[c] = new I_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<I_Result> cnt, CounterBrokenJCStressTest[] ls, I_Result[] lr, CounterBrokenJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            I_Result r = lr[c];
            CounterBrokenJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<I_Result> cnt, CounterBrokenJCStressTest[] ls, I_Result[] lr, CounterBrokenJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            I_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<I_Result> {
        CounterBrokenJCStressTest[] ss;
        I_Result[] rs;
        CounterBrokenJCStressTest test;

        public JcstressThread_actor1(CounterBrokenJCStressTest[] ss, I_Result[] rs, CounterBrokenJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            CounterBrokenJCStressTest[] ls = ss;
            I_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<I_Result> {
        ...
        public JcstressThread_actor2(CounterBrokenJCStressTest[] ss, I_Result[] rs, CounterBrokenJCStressTest test) {
