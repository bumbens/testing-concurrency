...
import thesis.JCStress.BrokenClasses.BrokenClassesTest.ArrayListBrokenJCStressTest;
import org.openjdk.jcstress.infra.results.Z_Result;

public final class BrokenClassesTest_ArrayListBrokenJCStressTest_jcstress extends Runner<Z_Result> {

    volatile WorkerSync workerSync;

    public BrokenClassesTest_ArrayListBrokenJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        ArrayListBrokenJCStressTest t;
        ArrayListBrokenJCStressTest s;
        Z_Result r;

        public JcstressThread_APICheck_actor1(ArrayListBrokenJCStressTest t, ArrayListBrokenJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(ArrayListBrokenJCStressTest t, ArrayListBrokenJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor3 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor3(ArrayListBrokenJCStressTest t, ArrayListBrokenJCStressTest s, Z_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<Z_Result> counter) throws Throwable {
        final ArrayListBrokenJCStressTest s = new ArrayListBrokenJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        ArrayListBrokenJCStressTest[] ss;
        Z_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(ArrayListBrokenJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(ArrayListBrokenJCStressTest[] ls, Z_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(ArrayListBrokenJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(ArrayListBrokenJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class JcstressThread_ResourceCheck_actor3 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor3(ArrayListBrokenJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor3(ArrayListBrokenJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor3();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            ArrayListBrokenJCStressTest[] ls = new ArrayListBrokenJCStressTest[size];
            Z_Result[] lr = new Z_Result[size];
            for (int c = 0; c < size; c++) {
                ArrayListBrokenJCStressTest s = new ArrayListBrokenJCStressTest();
    ...
    public ArrayList<CounterThread<Z_Result>> internalRun() {
        ...
        ArrayListBrokenJCStressTest[] ls = new ArrayListBrokenJCStressTest[len];
        Z_Result[] lr = new Z_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new ArrayListBrokenJCStressTest();
            lr[c] = new Z_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<Z_Result> cnt, ArrayListBrokenJCStressTest[] ls, Z_Result[] lr, ArrayListBrokenJCStressTest test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
            ArrayListBrokenJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<Z_Result> cnt, ArrayListBrokenJCStressTest[] ls, Z_Result[] lr, ArrayListBrokenJCStressTest test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<Z_Result> {
        ArrayListBrokenJCStressTest[] ss;
        Z_Result[] rs;
        ArrayListBrokenJCStressTest test;

        public JcstressThread_actor1(ArrayListBrokenJCStressTest[] ss, Z_Result[] rs, ArrayListBrokenJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            ArrayListBrokenJCStressTest[] ls = ss;
            Z_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor2(ArrayListBrokenJCStressTest[] ss, Z_Result[] rs, ArrayListBrokenJCStressTest test) {
    ...
    public class JcstressThread_actor3 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor3(ArrayListBrokenJCStressTest[] ss, Z_Result[] rs, ArrayListBrokenJCStressTest test) {
