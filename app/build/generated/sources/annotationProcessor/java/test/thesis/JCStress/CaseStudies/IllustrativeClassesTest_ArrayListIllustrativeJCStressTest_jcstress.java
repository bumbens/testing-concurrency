...
import thesis.JCStress.CaseStudies.IllustrativeClassesTest.ArrayListIllustrativeJCStressTest;
import org.openjdk.jcstress.infra.results.Z_Result;

public final class IllustrativeClassesTest_ArrayListIllustrativeJCStressTest_jcstress extends Runner<Z_Result> {

    volatile WorkerSync workerSync;

    public IllustrativeClassesTest_ArrayListIllustrativeJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        ArrayListIllustrativeJCStressTest t;
        ArrayListIllustrativeJCStressTest s;
        Z_Result r;

        public JcstressThread_APICheck_actor1(ArrayListIllustrativeJCStressTest t, ArrayListIllustrativeJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(ArrayListIllustrativeJCStressTest t, ArrayListIllustrativeJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor3 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor3(ArrayListIllustrativeJCStressTest t, ArrayListIllustrativeJCStressTest s, Z_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<Z_Result> counter) throws Throwable {
        final ArrayListIllustrativeJCStressTest s = new ArrayListIllustrativeJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        ArrayListIllustrativeJCStressTest[] ss;
        Z_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(ArrayListIllustrativeJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(ArrayListIllustrativeJCStressTest[] ls, Z_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(ArrayListIllustrativeJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(ArrayListIllustrativeJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class JcstressThread_ResourceCheck_actor3 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor3(ArrayListIllustrativeJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor3(ArrayListIllustrativeJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor3();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            ArrayListIllustrativeJCStressTest[] ls = new ArrayListIllustrativeJCStressTest[size];
            Z_Result[] lr = new Z_Result[size];
            for (int c = 0; c < size; c++) {
                ArrayListIllustrativeJCStressTest s = new ArrayListIllustrativeJCStressTest();
    ...
    public ArrayList<CounterThread<Z_Result>> internalRun() {
        ...
        ArrayListIllustrativeJCStressTest[] ls = new ArrayListIllustrativeJCStressTest[len];
        Z_Result[] lr = new Z_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new ArrayListIllustrativeJCStressTest();
            lr[c] = new Z_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<Z_Result> cnt, ArrayListIllustrativeJCStressTest[] ls, Z_Result[] lr, ArrayListIllustrativeJCStressTest test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
            ArrayListIllustrativeJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<Z_Result> cnt, ArrayListIllustrativeJCStressTest[] ls, Z_Result[] lr, ArrayListIllustrativeJCStressTest test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<Z_Result> {
        ArrayListIllustrativeJCStressTest[] ss;
        Z_Result[] rs;
        ArrayListIllustrativeJCStressTest test;

        public JcstressThread_actor1(ArrayListIllustrativeJCStressTest[] ss, Z_Result[] rs, ArrayListIllustrativeJCStressTest test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            ArrayListIllustrativeJCStressTest[] ls = ss;
            Z_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor2(ArrayListIllustrativeJCStressTest[] ss, Z_Result[] rs, ArrayListIllustrativeJCStressTest test) {
    ...
    public class JcstressThread_actor3 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor3(ArrayListIllustrativeJCStressTest[] ss, Z_Result[] rs, ArrayListIllustrativeJCStressTest test) {
