...
import thesis.JCStress.TurnstileJCStressTest;
import org.openjdk.jcstress.infra.results.L_Result;

public final class TurnstileJCStressTest_jcstress extends Runner<L_Result> {

    volatile WorkerSync workerSync;

    public TurnstileJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        TurnstileJCStressTest t;
        TurnstileJCStressTest s;
        L_Result r;

        public JcstressThread_APICheck_actor1(TurnstileJCStressTest t, TurnstileJCStressTest s, L_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(TurnstileJCStressTest t, TurnstileJCStressTest s, L_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<L_Result> counter) throws Throwable {
        final TurnstileJCStressTest s = new TurnstileJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        TurnstileJCStressTest[] ss;
        L_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(TurnstileJCStressTest[] ss, L_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(TurnstileJCStressTest[] ls, L_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(TurnstileJCStressTest[] ss, L_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(TurnstileJCStressTest[] ls, L_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            TurnstileJCStressTest[] ls = new TurnstileJCStressTest[size];
            L_Result[] lr = new L_Result[size];
            for (int c = 0; c < size; c++) {
                TurnstileJCStressTest s = new TurnstileJCStressTest();
    ...
    public ArrayList<CounterThread<L_Result>> internalRun() {
        ...
        TurnstileJCStressTest[] ls = new TurnstileJCStressTest[len];
        L_Result[] lr = new L_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new TurnstileJCStressTest();
            lr[c] = new L_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<L_Result> cnt, TurnstileJCStressTest[] ls, L_Result[] lr, TurnstileJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            L_Result r = lr[c];
            TurnstileJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<L_Result> cnt, TurnstileJCStressTest[] ls, L_Result[] lr, TurnstileJCStressTest test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            L_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<L_Result> {
        TurnstileJCStressTest[] ss;
        L_Result[] rs;
        TurnstileJCStressTest test;

        public JcstressThread_actor1(TurnstileJCStressTest[] ss, L_Result[] rs, TurnstileJCStressTest test) {
    ...
    public class JcstressThread_actor2 extends CounterThread<L_Result> {
        ...
        public JcstressThread_actor2(TurnstileJCStressTest[] ss, L_Result[] rs, TurnstileJCStressTest test) {
