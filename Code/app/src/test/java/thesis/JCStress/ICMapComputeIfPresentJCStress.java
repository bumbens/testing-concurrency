...
import thesis.Operations.ComputeIfPresent;
...
@State
public class ICMapComputeIfPresentJCStress {
    ...
    private final MapOperation<String, Integer> computeIfPresent = new ComputeIfPresent<String,Integer>("key", (k, v) -> computeValue);
    ...
    public void arbiter(IZ_Result r){
        ...
        map_seq1.computeIfPresent("key", (k, v) -> computeValue);

        //Sequence 2
        map_seq2.computeIfPresent("key", (k, v) -> computeValue);
