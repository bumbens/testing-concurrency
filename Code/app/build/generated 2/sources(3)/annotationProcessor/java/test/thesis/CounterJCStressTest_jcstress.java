...
public final class CounterJCStressTest_jcstress extends Runner<I_Result> {
    ...
    public ArrayList<CounterThread<I_Result>> internalRun() {
        ...
        gs = new CounterJCStressTest[len];
        gr = new I_Result[len];
        for (int c = 0; c < len; c++) {
            gs[c] = new CounterJCStressTest();
            gr[c] = new I_Result();
        }
    ...
    private void run_actor1(CounterJCStressTest[] gs, I_Result[] gr, int start, int end) {
        CounterJCStressTest[] ls = gs;
        I_Result[] lr = gr;
    ...
    private void run_actor2(CounterJCStressTest[] gs, I_Result[] gr, int start, int end) {
        CounterJCStressTest[] ls = gs;
        I_Result[] lr = gr;
        for (int c = start; c < end; c++) {
            CounterJCStressTest s = ls[c];
