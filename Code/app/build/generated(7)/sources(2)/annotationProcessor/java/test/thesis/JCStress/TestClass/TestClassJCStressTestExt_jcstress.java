...
import thesis.JCStress.TestClass.TestClassJCStressTestExt;
import org.openjdk.jcstress.infra.results.Z_Result;

public final class TestClassJCStressTestExt_jcstress extends Runner<Z_Result> {

    volatile WorkerSync workerSync;

    public TestClassJCStressTestExt_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        TestClassJCStressTestExt t;
        TestClassJCStressTestExt s;
        Z_Result r;

        public JcstressThread_APICheck_actor1(TestClassJCStressTestExt t, TestClassJCStressTestExt s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(TestClassJCStressTestExt t, TestClassJCStressTestExt s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor3 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor3(TestClassJCStressTestExt t, TestClassJCStressTestExt s, Z_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<Z_Result> counter) throws Throwable {
        final TestClassJCStressTestExt s = new TestClassJCStressTestExt();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        TestClassJCStressTestExt[] ss;
        Z_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(TestClassJCStressTestExt[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(TestClassJCStressTestExt[] ls, Z_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(TestClassJCStressTestExt[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(TestClassJCStressTestExt[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class JcstressThread_ResourceCheck_actor3 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor3(TestClassJCStressTestExt[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor3(TestClassJCStressTestExt[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor3();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            TestClassJCStressTestExt[] ls = new TestClassJCStressTestExt[size];
            Z_Result[] lr = new Z_Result[size];
            for (int c = 0; c < size; c++) {
                TestClassJCStressTestExt s = new TestClassJCStressTestExt();
    ...
    public ArrayList<CounterThread<Z_Result>> internalRun() {
        ...
        TestClassJCStressTestExt[] ls = new TestClassJCStressTestExt[len];
        Z_Result[] lr = new Z_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new TestClassJCStressTestExt();
            lr[c] = new Z_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<Z_Result> cnt, TestClassJCStressTestExt[] ls, Z_Result[] lr, TestClassJCStressTestExt test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
            TestClassJCStressTestExt s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<Z_Result> cnt, TestClassJCStressTestExt[] ls, Z_Result[] lr, TestClassJCStressTestExt test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<Z_Result> {
        TestClassJCStressTestExt[] ss;
        Z_Result[] rs;
        TestClassJCStressTestExt test;

        public JcstressThread_actor1(TestClassJCStressTestExt[] ss, Z_Result[] rs, TestClassJCStressTestExt test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            TestClassJCStressTestExt[] ls = ss;
            Z_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor2(TestClassJCStressTestExt[] ss, Z_Result[] rs, TestClassJCStressTestExt test) {
    ...
    public class JcstressThread_actor3 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor3(TestClassJCStressTestExt[] ss, Z_Result[] rs, TestClassJCStressTestExt test) {
