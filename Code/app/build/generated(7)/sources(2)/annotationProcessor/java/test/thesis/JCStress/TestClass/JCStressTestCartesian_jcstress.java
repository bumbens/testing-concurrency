...
import thesis.JCStress.TestClass.JCStressTestCartesian;
import org.openjdk.jcstress.infra.results.Z_Result;

public final class JCStressTestCartesian_jcstress extends Runner<Z_Result> {

    volatile WorkerSync workerSync;

    public JCStressTestCartesian_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        JCStressTestCartesian t;
        JCStressTestCartesian s;
        Z_Result r;

        public JcstressThread_APICheck_actor1(JCStressTestCartesian t, JCStressTestCartesian s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(JCStressTestCartesian t, JCStressTestCartesian s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor3 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor3(JCStressTestCartesian t, JCStressTestCartesian s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor4 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor4(JCStressTestCartesian t, JCStressTestCartesian s, Z_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<Z_Result> counter) throws Throwable {
        final JCStressTestCartesian s = new JCStressTestCartesian();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        JCStressTestCartesian[] ss;
        Z_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(JCStressTestCartesian[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(JCStressTestCartesian[] ls, Z_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(JCStressTestCartesian[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(JCStressTestCartesian[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class JcstressThread_ResourceCheck_actor3 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor3(JCStressTestCartesian[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor3(JCStressTestCartesian[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor3();
            }
        }
    ...
    private static class JcstressThread_ResourceCheck_actor4 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor4(JCStressTestCartesian[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor4(JCStressTestCartesian[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor4();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            JCStressTestCartesian[] ls = new JCStressTestCartesian[size];
            Z_Result[] lr = new Z_Result[size];
            for (int c = 0; c < size; c++) {
                JCStressTestCartesian s = new JCStressTestCartesian();
    ...
    public ArrayList<CounterThread<Z_Result>> internalRun() {
        ...
        JCStressTestCartesian[] ls = new JCStressTestCartesian[len];
        Z_Result[] lr = new Z_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new JCStressTestCartesian();
            lr[c] = new Z_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<Z_Result> cnt, JCStressTestCartesian[] ls, Z_Result[] lr, JCStressTestCartesian test, int len, int a) {
        int left = a * len / 4;
        int right = (a + 1) * len / 4;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
            JCStressTestCartesian s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<Z_Result> cnt, JCStressTestCartesian[] ls, Z_Result[] lr, JCStressTestCartesian test, int len, int a) {
        int left = a * len / 4;
        int right = (a + 1) * len / 4;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<Z_Result> {
        JCStressTestCartesian[] ss;
        Z_Result[] rs;
        JCStressTestCartesian test;

        public JcstressThread_actor1(JCStressTestCartesian[] ss, Z_Result[] rs, JCStressTestCartesian test) {
    ...
    public class JcstressThread_actor2 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor2(JCStressTestCartesian[] ss, Z_Result[] rs, JCStressTestCartesian test) {
    ...
    public class JcstressThread_actor3 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor3(JCStressTestCartesian[] ss, Z_Result[] rs, JCStressTestCartesian test) {
    ...
    public class JcstressThread_actor4 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor4(JCStressTestCartesian[] ss, Z_Result[] rs, JCStressTestCartesian test) {
