...
import thesis.JCStress.ICMap.ICMapComputeIfAbsentJCStress;
import org.openjdk.jcstress.infra.results.IZ_Result;

public final class ICMapComputeIfAbsentJCStress_jcstress extends Runner<IZ_Result> {

    volatile WorkerSync workerSync;

    public ICMapComputeIfAbsentJCStress_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        ICMapComputeIfAbsentJCStress t;
        ICMapComputeIfAbsentJCStress s;
        IZ_Result r;

        public JcstressThread_APICheck_actor1(ICMapComputeIfAbsentJCStress t, ICMapComputeIfAbsentJCStress s, IZ_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(ICMapComputeIfAbsentJCStress t, ICMapComputeIfAbsentJCStress s, IZ_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<IZ_Result> counter) throws Throwable {
        final ICMapComputeIfAbsentJCStress s = new ICMapComputeIfAbsentJCStress();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        ICMapComputeIfAbsentJCStress[] ss;
        IZ_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(ICMapComputeIfAbsentJCStress[] ss, IZ_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(ICMapComputeIfAbsentJCStress[] ls, IZ_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(ICMapComputeIfAbsentJCStress[] ss, IZ_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(ICMapComputeIfAbsentJCStress[] ls, IZ_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            ICMapComputeIfAbsentJCStress[] ls = new ICMapComputeIfAbsentJCStress[size];
            IZ_Result[] lr = new IZ_Result[size];
            for (int c = 0; c < size; c++) {
                ICMapComputeIfAbsentJCStress s = new ICMapComputeIfAbsentJCStress();
    ...
    public ArrayList<CounterThread<IZ_Result>> internalRun() {
        ...
        ICMapComputeIfAbsentJCStress[] ls = new ICMapComputeIfAbsentJCStress[len];
        IZ_Result[] lr = new IZ_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new ICMapComputeIfAbsentJCStress();
            lr[c] = new IZ_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<IZ_Result> cnt, ICMapComputeIfAbsentJCStress[] ls, IZ_Result[] lr, ICMapComputeIfAbsentJCStress test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            IZ_Result r = lr[c];
            ICMapComputeIfAbsentJCStress s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<IZ_Result> cnt, ICMapComputeIfAbsentJCStress[] ls, IZ_Result[] lr, ICMapComputeIfAbsentJCStress test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            IZ_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<IZ_Result> {
        ICMapComputeIfAbsentJCStress[] ss;
        IZ_Result[] rs;
        ICMapComputeIfAbsentJCStress test;

        public JcstressThread_actor1(ICMapComputeIfAbsentJCStress[] ss, IZ_Result[] rs, ICMapComputeIfAbsentJCStress test) {
        ...
        private void jcstress_stride_actor1(int start, int end) {
            ICMapComputeIfAbsentJCStress[] ls = ss;
            IZ_Result[] lr = rs;
    ...
    public class JcstressThread_actor2 extends CounterThread<IZ_Result> {
        ...
        public JcstressThread_actor2(ICMapComputeIfAbsentJCStress[] ss, IZ_Result[] rs, ICMapComputeIfAbsentJCStress test) {
