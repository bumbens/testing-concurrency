...
import thesis.JCStress.TestClass.TestClassJCStressTest;
...
public final class TestClassJCStressTest_jcstress extends Runner<Z_Result> {

    volatile WorkerSync workerSync;

    public TestClassJCStressTest_jcstress(ForkedTestConfig config) {
        super(config);
    }
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        TestClassJCStressTest t;
        TestClassJCStressTest s;
        Z_Result r;

        public JcstressThread_APICheck_actor1(TestClassJCStressTest t, TestClassJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(TestClassJCStressTest t, TestClassJCStressTest s, Z_Result r) {
    ...
    private static class JcstressThread_APICheck_actor3 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor3(TestClassJCStressTest t, TestClassJCStressTest s, Z_Result r) {
    ...
    private void jcstress_sanityCheck_API(Counter<Z_Result> counter) throws Throwable {
        final TestClassJCStressTest s = new TestClassJCStressTest();
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        TestClassJCStressTest[] ss;
        Z_Result[] rs;
        int size;

        public JcstressThread_ResourceCheck_actor1(TestClassJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(TestClassJCStressTest[] ls, Z_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(TestClassJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(TestClassJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    private static class JcstressThread_ResourceCheck_actor3 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor3(TestClassJCStressTest[] ss, Z_Result[] rs, int size) {
        ...
        private void jcstress_check_actor3(TestClassJCStressTest[] ls, Z_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor3();
            }
        }
    ...
    private static class TestResourceEstimator implements ResourceEstimator {
        ...
        public void runWith(int size, long[] cnts) {
            ...
            TestClassJCStressTest[] ls = new TestClassJCStressTest[size];
            Z_Result[] lr = new Z_Result[size];
            for (int c = 0; c < size; c++) {
                TestClassJCStressTest s = new TestClassJCStressTest();
    ...
    public ArrayList<CounterThread<Z_Result>> internalRun() {
        ...
        TestClassJCStressTest[] ls = new TestClassJCStressTest[len];
        Z_Result[] lr = new Z_Result[len];
        for (int c = 0; c < len; c++) {
            ls[c] = new TestClassJCStressTest();
            lr[c] = new Z_Result();
        }
    ...
    public static void jcstress_ni_consume_final(Counter<Z_Result> cnt, TestClassJCStressTest[] ls, Z_Result[] lr, TestClassJCStressTest test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
            TestClassJCStressTest s = ls[c];
            s.arbiter(r);
            cnt.record(r, 1);
        }
    }

    public static void jcstress_consume_reinit(Counter<Z_Result> cnt, TestClassJCStressTest[] ls, Z_Result[] lr, TestClassJCStressTest test, int len, int a) {
        int left = a * len / 3;
        int right = (a + 1) * len / 3;
        for (int c = left; c < right; c++) {
            Z_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<Z_Result> {
        TestClassJCStressTest[] ss;
        Z_Result[] rs;
        TestClassJCStressTest test;

        public JcstressThread_actor1(TestClassJCStressTest[] ss, Z_Result[] rs, TestClassJCStressTest test) {
    ...
    public class JcstressThread_actor2 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor2(TestClassJCStressTest[] ss, Z_Result[] rs, TestClassJCStressTest test) {
    ...
    public class JcstressThread_actor3 extends CounterThread<Z_Result> {
        ...
        public JcstressThread_actor3(TestClassJCStressTest[] ss, Z_Result[] rs, TestClassJCStressTest test) {
