...
import thesis.ICMapComputeJCStress;
import org.openjdk.jcstress.infra.results.II_Result;

public final class ICMapComputeJCStress_jcstress extends Runner<II_Result> {
    ...
    private static class JcstressThread_APICheck_actor1 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor1(ICMapComputeJCStress t, ICMapComputeJCStress s, II_Result r) {
    ...
    private static class JcstressThread_APICheck_actor2 extends VoidThread {
        ...
        public JcstressThread_APICheck_actor2(ICMapComputeJCStress t, ICMapComputeJCStress s, II_Result r) {
    ...
    private static class JcstressThread_ResourceCheck_actor1 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor1(ICMapComputeJCStress[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor1(ICMapComputeJCStress[] ls, II_Result[] lr, int size) {
    ...
    private static class JcstressThread_ResourceCheck_actor2 extends LongThread {
        ...
        public JcstressThread_ResourceCheck_actor2(ICMapComputeJCStress[] ss, II_Result[] rs, int size) {
        ...
        private void jcstress_check_actor2(ICMapComputeJCStress[] ls, II_Result[] lr, int size) {
            for (int c = 0; c < size; c++) {
                ls[c].actor2();
            }
        }
    ...
    public static void jcstress_ni_consume_final(Counter<II_Result> cnt, ICMapComputeJCStress[] ls, II_Result[] lr, ICMapComputeJCStress test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
    ...
    public static void jcstress_consume_reinit(Counter<II_Result> cnt, ICMapComputeJCStress[] ls, II_Result[] lr, ICMapComputeJCStress test, int len, int a) {
        int left = a * len / 2;
        int right = (a + 1) * len / 2;
        for (int c = left; c < right; c++) {
            II_Result r = lr[c];
    ...
    public class JcstressThread_actor1 extends CounterThread<II_Result> {
        ICMapComputeJCStress[] ss;
        II_Result[] rs;
        ICMapComputeJCStress test;

        public JcstressThread_actor1(ICMapComputeJCStress[] ss, II_Result[] rs, ICMapComputeJCStress test) {
        ...
        private Counter<II_Result> jcstress_iteration_actor1() {
            int len = config.strideSize * config.strideCount;
    ...
    public class JcstressThread_actor2 extends CounterThread<II_Result> {
        ICMapComputeJCStress[] ss;
        II_Result[] rs;
        ICMapComputeJCStress test;

        public JcstressThread_actor2(ICMapComputeJCStress[] ss, II_Result[] rs, ICMapComputeJCStress test) {
        ...
        private Counter<II_Result> jcstress_iteration_actor2() {
            int len = config.strideSize * config.strideCount;
            int stride = config.strideSize;
            Counter<II_Result> counter = new Counter<>();
